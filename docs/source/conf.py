...
# kedro_diabetes_ml documentation build
...
from kedro_diabetes_ml import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_diabetes_ml"
author = "Kedro"
...
htmlhelp_basename = "kedro_diabetes_mldoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_diabetes_ml.tex",
        "kedro_diabetes_ml Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_diabetes_ml",
        "Project kedro_diabetes_ml codebase.",
        "Data-Science",
    )
]
